...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 2
    actual = count_negatives([997630, 5413, -526, -0.0000001])
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives((-112304, 22546878, -5456215, 1, 215, -943))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 1
    seq = [[8, 5, 44, 6, 1], [0.25, 26, 2], [], [14,-.0122, 154, 2]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 2
    seq = [[], [-97754, 215, -0.111122], [1, 2], [3, 6, 9]]
    actual = count_short_ones(seq)
    print()
